        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="error">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="admin/quanlykhachsan"> Quản lý khách sạn </a></li>
                <li class="nav-item"> <a class="nav-link" href="admin/quanlytour"> Quản lý tour </a></li>
              </ul>
            </div>
          </li>
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Admin Trip Ticks</h3>
                </div>
                <div class="col-12 col-xl-4">
                 <div class="justify-content-end d-flex">
                  <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuDate2" id="quarterMenu">
...
<script>
  // Hàm định dạng ngày theo kiểu dd MMM yyyy
  function formatDate(date) {
    const options = { day: '2-digit', month: 'short', year: 'numeric' };
    return date.toLocaleDateString('en-GB', options).replace(/ /g, ' ');
  }

  // Cập nhật nội dung ngày vào nút dropdown
...
<script>
  ...
  // Hàm tạo danh sách quý
  function generateQuarters(year) {
    return [
      { label: `Q1 (Jan - Mar ${year})`, range: 'January - March' },
      { label: `Q2 (Apr - Jun ${year})`, range: 'April - June' },
      { label: `Q3 (Jul - Sep ${year})`, range: 'July - September' },
      { label: `Q4 (Oct - Dec ${year})`, range: 'October - December' }
    ];
  }
